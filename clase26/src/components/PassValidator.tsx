...
const PassValidator = () => {
  ...
  return (
    <div className="p-6 max-w-md mx-auto bg-slate-800 text-white rounded-lg shadow-2xl space-y-4">
        ...
        <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="w-full p-2 rounded bg-slate-700 border border-slate-600 focus:border-cyan-400 outline-none" />

        {/* RENDERIZADO CONDICIONAL CON &&, ESTO SOLO SE MUESTRA SI LA CONDICION ES TRUE */}
