...
const PORT = 3001;
const DB_NAME = 'cafeteria_basica';
...
app.use('/clientes', createRouterCrud('Cliente', collections.clientes))
app.use('/pedidos', createRouterCrud('Pedidos', collections.pedidos))
